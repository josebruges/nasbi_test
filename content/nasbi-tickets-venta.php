...
<head>
    ...
    <meta name="title" content="<?php echo $result["_trans908_SEO"] ?>">
    <meta property="og:title" content="<?php echo $result["_trans908_SEO"] ?>">
    <meta name="description" content="<?php echo $result["_trans909_SEO"] ?>" />
    <meta property="og:description" content="<?php echo $result["_trans909_SEO"] ?>" />
    <meta name="keywords" content="<?php echo $result["_trans919_SEO"] ?>">
    <meta property="og:keywords" content="<?php echo $result["_trans919_SEO"] ?>">
    <meta property="og:image" content="https://nasbi.com/imagen/logo_150x150.png">
    <title class="trans_149">Nasbi.com | Nasbi-tickets</title>
    ...
    ?>
    <!-- link css -->
    <link rel="stylesheet" href="../css/nasbi-tickets-venta.css">
</head>
...
<?php include '../include/body_general.php'; ?>
    <div align="center" class="pb-5">
        <!-- <div class="banner-tickets">
            <div class="content-title">
                ...
                <h1 class="title">Tickets <span><img loading="lazy" alt="logo-nasbi-nasbi.com" src="../imagen/nasbi-white.png"></span></h1>
        ...
        <div class="row row-cards pt-0 pb-0 tkv__content_planes">
            <div class="col-sm-6 col-md-4 px-md-1 px-lg-3 tkc__no_data3" style="display:none">
    ...
    <div class="modal fade" id="modal-tickets-info-payu" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content content-modal">
                <div class="modal-body">
                    <div class="row">
...
<script src="../js/controllers/nasbi-tiquets-venta.js"></script>
