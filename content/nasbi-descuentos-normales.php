...
<head>
    ...
    <meta name="title" content="<?php echo $result["_trans906_SEO"]?>" >
    <meta property="og:title" content="<?php echo $result["_trans906_SEO"]?>" >
    <meta name="description" content="<?php echo $result["_trans907_SEO"]?>" >
    <meta property="og:description" content="<?php echo $result["_trans907_SEO"]?>" >
    <meta name="keywords" content="<?php echo $result["_trans920_SEO"]?>" >
    <meta property="og:keywords" content="<?php echo $result["_trans920_SEO"]?>" >
    <title class="_trans531">Nasbi.com | Subastas Nasbi</title>
    ...
    <link rel="stylesheet" href="../css/subastas-nasbi.css">
    ...
    <div align="center">
        ...
        <div class="row">
            <div class="col-12 p-0">
                <div class="owl-carousel owl-theme" id="carousel-banner-subastas-nasbi"></div>
            </div>

            <div class="col-12 p-0">
                <div class="franja-info trans444_"></div>
            </div>
        </div>
        ...
        <div class="row row-circle">
            ...
            <div class="col-sm-6 col-lg-3 col3circle">
                ...
                <div class="container-info">
                    ...
                    <span><img src="../imagen/subastas/wallet.png"></span>
                    <span class="text-inf trans445_">Recarga tu <br>billetera con saldo</span>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 col3circle">
                <div class="div-circle"></div>
                <div class="container-info">
                    ...
                    <span><img src="../imagen/subastas/paso3.png"></span>
                    <span class="text-inf trans446_">Inscríbete y <br>prepárate para ganar</span>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 col3circle">
                <div class="div-circle"></div>
                <div class="container-info">
                    ...
                    <span class="text-inf trans447_"></span>
                </div>
            </div>
        </div>
        ...
        <!-- <div class="row row-12-back">
            <!-- Subastas nasbi 
            <div class="col-12">
                <div class="owl-carousel owl-theme carousel-subastas" id="subastas-nasbi">
            ...
            <div class="col-12 subastas__nasbi__content__pagination"></div>
        </div> -->
        ...
        <div class="row mb-5">
                    ...
                    <div class="row row3-filter">
                        <div class="row">
                            <div class="col-12 p-0">
                                <div class="input-group group-filter">
                                    <input type="text" class="form-control buscarnombre_subasta_nor _trans383__ph" placeholder="¿Qué te gustaría ordenar?">
                                    <span class="input-group-addon buscarsubasta_nor"><i class="fas fa-search"></i></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-filter">
                            ...
                            <div class="col-12 collapse" id="tiempo-uso">
                                <form class="condiciondeuso_subasta_nor">
                                    <p class="tex-radio"><span class="trans_47"></span> <span><input type="Radio" name="colorin_subas_nor" value="0" class="tratex-radio ns_47"> </span></p>

                                    <p class="tex-radio"><span class="trans_48"></span> <span><input type="Radio" name="colorin_subas_nor" value="1" class="tratex-radio ns4"></span></p>

                                    <p class="tex-radio"><span class="trans_49"></span> <span><input type="Radio" name="colorin_subas_nor" value="2" class="tratex-radio ns5"></span></p>

                                    <p class="tex-radio"><span class="trans_50"></span> <span><input type="Radio" name="colorin_subas_nor" value="3" class="tratex-radio ns6"></span></p>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row row-filter">
                            ...
                            <div class="col-12 collapse" id="garantia">
                                <form class="respuestagarantia_subas_nor">
                                    <p class="tex-radio"><span class="trans_47"></span> <span><input type="Radio" name="colorin_subas_nor" value="2" class="trans4"></span></p>

                                    <p class="tex-radio"><span class="trans24_"></span> <span><input type="Radio" name="colorin_subas_nor" value="1" class="trans4"> </span></p>

                                    <p class="tex-radio"><span class="trans25_"></span> <span><input type="Radio" name="colorin_subas_nor" value="0" class="trans5"></span></p>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row row-filter">
                            ...
                            <div class="col-12 collapse" id="promocion2">
                                <form class="tipoenvio_subas_nor">
                                    <p class="tex-radio"><span class="trans_47"></span> <span><input type="Radio" name="colorin_subas_nor" value="0" class="trans4"> </span></p>

                                    <p class="tex-radio"><span class="trans26_"></span> <span><input type="Radio" name="colorin_subas_nor" value="1" class="trans5"> </span></p>

                                    <p class="tex-radio"><span class="trans27_"></span> <span><input type="Radio" name="colorin_subas_nor" value="2" class="trans5"> </span></p>

                                    <p class="tex-radio"><span class="trans28_"></span> <span><input type="Radio" name="colorin_subas_nor" value="3" class="trans5"> </span></p>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row row-filter">
                            ...
                            <div class="col-12 collapse" id="ordenamiento">
                                <form class="ordenamientoproducto_subas_nor">

                                    <p class="tex-radio"><span class="trans29_"></span> <span><input type="Radio" name="colorin_subas_nor" value="ASC" class="trans4"> </span></p>

                                    <p class="tex-radio"><span class="trans30_"></span> <span><input type="Radio" name="colorin_subas_nor" value="DESC" class="trans5"></span></p>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 px-2">
                                <div class="content-btn-filter">
                                    <button class="btn-1 trans22_ buscarsubasta_nor"></button>
                                    <button class="btn-2 trans23_ limpiarsubasta_nor"></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-9">
                <div class="row content__loadingSpinner_filter_subasta_nor">
                ...
                <div class="row products__list_subasta_normal"></div>

                <div class="row products__list__nodata_subasta_normal">
                    <div class="col-lg-12">
                ...
                <div class="list__subasta_nor__pagination"></div>
            </div>
        </div>
...
<script src="../js/controllers/subastas/subastas-nasbi.js"></script>
